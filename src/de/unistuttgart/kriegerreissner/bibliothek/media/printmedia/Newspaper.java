...
public class Newspaper extends PrintMedia {
     ...
     */
    public Newspaper(final String id, final String title, final Library parentLibrary, final Set<String> authors, final int numberPages, final BookCoverType coverType) {
