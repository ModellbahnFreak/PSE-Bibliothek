 ...
 */
public class Jounal extends PrintMedia {
     ...
     */
    public Jounal(final String id, final String title, final Library parentLibrary, final Set<String> authors, final int numberPages, final BookCoverType coverType) {
