...
public class Book extends PrintMedia {
     ...
     */
    private Book(final String id, final String title, final Library parentLibrary, final Set<String> authors,
                 final int numberPages, final BookCoverType coverType) {
