...
public class Video extends MultiMedia {
    /**
     * <p>Constructor setting the id and title of the video.</p>
     *
     ...
     */
    protected Video(final String id, final String title, final String mediaUrl, final int lenSec, final String mimeType) {
